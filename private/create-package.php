...
<?php
    if (isset($_SESSION['uid'])) {
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if (!empty($name) && !empty($price) && !empty($upload)) {
                $uploadStatus = 1;
                    ...
                    if ($imgSize > 5000) {
                        ...
                        if (file_exists($targetFile)) {
                           ...
                           if(move_uploaded_file($temp, $targetFile)) {
                                ...
                                $query = "INSERT INTO package(name,category,subcategory,price,image,detail,created) 
                                        VALUES('$name',$cat,$sub,$price,'$filename','$details',$created)";
                        ...
                        <div class="col-sm-6 col-md-offset-3">
                            <div class="card">
                                <div class="card-header">
                                    <h2>Create Package <small>You can add as many sub packages as possible.</small></h2>
                                </div>
                                ...
                                <div class="card-body card-padding">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group fg-line">
                                            ...
                                            <input type="text" class="form-control input-sm" id="inputCategory" placeholder="Enter Package name" name="package">
                                        </div>
                                        ...
                                        <div class="form-group line">
                                        <p class="f-500 m-b-15 c-black">Select Sub Category</p>

                                            <select class="selectpicker" data-live-search="true" name="subcategory">
                                                <?php 
                                        ...
                                        <div class="form-group fg-line">
                                            <label for="inputLastname">Package Price</label>
                                            <input type="text" class="form-control input-sm" id="inputDescription" placeholder="Package Price" name="price">
                                        </div>

                                        <div class="form-group fg-line">
                                            <label for="inputLastname">Description</label>
                                            <input type="text" class="form-control input-sm" id="inputDescription" placeholder="Enter Description" name="detail">
                                        </div>
                                        <div class="form-group line">
