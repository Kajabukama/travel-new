                                ...
                                <div class="card-header bgm-cyan">
                                    ...
                                    <ul class="actions actions-alt">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="reply-enquiry.php?user=<?php echo $uid; ?>&mid=<?php echo$val['id'];?>&action=reply">Reply</a></li>
                                                <li><a href="send-sms.php?user=<?php echo $uid; ?>&mid=<?php echo $val['id'];?>&action=send-sms">Send SMS</a></li>
                                                <li><a href="delete.php?user=<?php echo $uid; ?>&mid=<?php echo $val['id'];?>&action=delete-enquiry">Delete</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
