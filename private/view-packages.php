                        ...
                        <div class="card">
                            <div class="listview lv-bordered lv-lg">
                                <div class="lv-header-alt clearfix">
                                    <h2 class="lvh-label hidden-xs">Available Packages</h2>
                                    ...
                                    <div class="lv-body">
                                        ...
                                        <?php  foreach($packages as $key => $value): ?>
                                            ...
                                            <div class="lv-item media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" 
                                                    src="img/uploads/<?php echo $value['image']; ?>" alt="">
                                                </div>
                                                <div class="media-body">
                                                    ...
                                                    <div class="lv-actions actions dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            <li><a href="update-package.php?subcatid=<?php echo $value['id'];?>">Edit</a></li>
                                                            <li><a href="delete.php?pid=<?php echo $value['id'];?>&action=delete-package">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
