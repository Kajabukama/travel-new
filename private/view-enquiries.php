                        ...
                        <div class="card">
                            <div class="listview lv-bordered lv-lg">
                                <div class="lv-header-alt clearfix">
                                    <h2 class="lvh-label hidden-xs">Available Enquiries</h2>
                                    
                                    <div class="lvh-search">
                                        <input type="text" placeholder="Search messages..." class="lvhs-input">
                                    ...
                                    <div class="lv-body">
                                        ...
                                        <a class="lv-item" href="view-details.php?user=<?php echo $uid; ?>&mid=<?php echo $val['id']; ?>">
                                            <div class="media">
                                                <div class="pull-left">
