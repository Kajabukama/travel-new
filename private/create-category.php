        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if(!empty($category) && !empty($description)){
                ...
                if(mysqli_num_rows($result) > 0){
                    echo "<script>alert('The catgeory you provided already exists');</script>";
                } else {

                    $query = "INSERT INTO category (name, description, created) 
                    VALUES('$category','$description',$created)";
                    $result = mysqli_query($link, $query);
                        ...
                        <div class="col-sm-6 col-md-offset-3">
                            <div class="card">
                                <div class="card-header">
                                    <h2>Create Category <small>You can add as many categories as possible.</small></h2>
                                </div>
                                ...
                                <div class="card-body card-padding">
                                    <form role="form" action="" method="POST">
                                        <div class="form-group fg-line">
                                            ...
                                            <input type="text" class="form-control input-sm" id="inputCategory" placeholder="Enter category" name="category">
                                        </div>
